        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DepartureAirportCode = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: false),
                    ArrivalAirportCode = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: false),
                    DepartureTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ArrivalTime = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FlightLegs", x => x.LegId);
                    table.ForeignKey(
                        name: "FK_FlightLegs_Airports_ArrivalAirportCode",
                        column: x => x.ArrivalAirportCode,
                        principalTable: "Airports",
                        principalColumn: "AirportCode",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FlightLegs_Airports_DepartureAirportCode",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FlightStaffs", x => x.FlightStaffId);
                    table.ForeignKey(
                        name: "FK_FlightStaffs_Flights_FlightId",
                        column: x => x.FlightId,
                        principalTable: "Flights",
                        principalColumn: "FlightId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FlightStaffs_Staffs_StaffId",
                        column: x => x.StaffId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FlightStatuses", x => x.StatusId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Tickets_FlightLegs_LegId",
                        column: x => x.LegId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 160, "Boeing", "Boeing 737" },
                    { 2, 150, "Airbus", "Airbus A320" }
                });

            migrationBuilder.InsertData(
                table: "Customers",
                columns: new[] { "CustomerId", "DOB", "Email", "FirstName", "LastName", "PassportNumber", "Phone" },
                values: new object[,]
                {
                    { 1, new DateTime(1985, 5, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "john@example.com", "John", "Doe", "P10001", "1234567890" },
                    { 2, new DateTime(1990, 7, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "jane@example.com", "Jane", "Smith", "P10002", "1234567891" }
                });

            migrationBuilder.InsertData(
                table: "Flights",
                columns: new[] { "FlightId", "AircraftId", "FlightNumber" },
                values: new object[,]
                {
                    { 1, 1, "AA100" },
                    { 2, 2, "DL200" }
            ...
            migrationBuilder.InsertData(
                table: "Seats",
                columns: new[] { "SeatId", "AircraftId", "FlightId", "IsBooked", "SeatClass", "SeatNumber" },
                values: new object[,]
                {
                    { 1, 1, 1, false, "Economy", "1A" },
                    { 2, 1, 1, false, "Economy", "1B" },
                    { 3, 2, 2, false, "Economy", "1A" },
                    { 4, 2, 2, false, "Economy", "1B" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FlightLegs_ArrivalAirportCode",
                table: "FlightLegs",
                column: "ArrivalAirportCode");

            migrationBuilder.CreateIndex(
                name: "IX_FlightLegs_DepartureAirportCode",
                table: "FlightLegs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FlightStaffs_FlightId",
                table: "FlightStaffs",
                column: "FlightId");

            migrationBuilder.CreateIndex(
                name: "IX_FlightStaffs_StaffId",
                table: "FlightStaffs",
                column: "StaffId");

            migrationBuilder.CreateIndex(
                name: "IX_FlightStatuses_FlightId",
